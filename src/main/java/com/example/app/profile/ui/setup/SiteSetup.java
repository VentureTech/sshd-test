...
package net.venturetech.sshd_test.profile.ui.setup;

import net.venturetech.sshd_test.profile.model.company.Company;
import net.venturetech.sshd_test.profile.model.company.CompanyStatus;
import net.venturetech.sshd_test.profile.model.setup.SiteSetupDAO;
...
import net.venturetech.sshd_test.profile.ui.company.AbstractCompanyPropertyEditor;
...
import static net.venturetech.sshd_test.profile.ui.setup.SiteSetupLOK.COMPONENT_NAME;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.profile.ui.setup.SiteSetup",
    i18n = {
