...
import net.venturetech.sshd_test.profile.model.ProfileType;
...
import net.venturetech.sshd_test.profile.model.membership.MembershipTypeProvider;
...
import static net.venturetech.sshd_test.profile.ui.user.ProfileMembershipManagementLOK.*;
import static net.venturetech.sshd_test.profile.ui.user.UserMembershipManagementLOK.BUTTON_TEXT_MODIFY;
import static net.venturetech.sshd_test.profile.ui.user.UserMembershipManagementLOK.DELETE_CONFIRM_TEXT_FMT;
import static net.venturetech.sshd_test.support.service.AppUtil.*;
...
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.profile.ui.user.ProfileRoleManagement",
    i18n = {
