...
package net.venturetech.sshd_test.profile.ui.repository;
...
import net.venturetech.sshd_test.support.ui.search.SelectActionColumn;
...
import static net.venturetech.sshd_test.profile.ui.repository.ResourceSelectorLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.profile.ui.repository.ResourceSelector",
    i18n = {
