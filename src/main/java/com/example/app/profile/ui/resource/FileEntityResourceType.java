...
import net.venturetech.sshd_test.profile.model.resource.FileEntityResource;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.profile.ui.resource.FileEntityResourceType",
    i18n = {
