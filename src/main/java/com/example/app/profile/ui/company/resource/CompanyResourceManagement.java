...
import net.venturetech.sshd_test.profile.model.Profile;
import net.venturetech.sshd_test.profile.model.ProfileDAO;
import net.venturetech.sshd_test.profile.model.company.Company;
import net.venturetech.sshd_test.profile.model.repository.Repository;
import net.venturetech.sshd_test.profile.model.repository.RepositoryDAO;
import net.venturetech.sshd_test.profile.model.repository.RepositoryItemRelation;
import net.venturetech.sshd_test.profile.model.repository.RepositoryItemRelationType;
import net.venturetech.sshd_test.profile.model.repository.RepositoryItemStatus;
import net.venturetech.sshd_test.profile.model.repository.ResourceRepositoryItem;
import net.venturetech.sshd_test.profile.model.resource.Resource;
...
import net.venturetech.sshd_test.profile.service.resource.ResourceCategoryLabelProvider;
import net.venturetech.sshd_test.profile.service.resource.ResourceTagsLabelProvider;
import net.venturetech.sshd_test.profile.service.resource.ResourceTypeService;
import net.venturetech.sshd_test.profile.ui.ApplicationFunctions;
import net.venturetech.sshd_test.profile.ui.URLProperties;
import net.venturetech.sshd_test.support.service.AppUtil;
import net.venturetech.sshd_test.support.ui.Application;
...
import static net.venturetech.sshd_test.profile.ui.UIText.REPOSITORY;
import static net.venturetech.sshd_test.profile.ui.UIText.RESOURCE;
import static net.venturetech.sshd_test.profile.ui.company.resource.CompanyResourceManagementLOK.*;
import static net.venturetech.sshd_test.support.service.AppUtil.nullFirst;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.profile.ui.company.resource.CompanyResourceManagement",
    i18n = {
