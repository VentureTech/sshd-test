...
import net.venturetech.sshd_test.support.ui.CustomCKEditorConfig;
...
import static net.venturetech.sshd_test.profile.ui.user.MessageContextValueEditorLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.profile.ui.user.MessageContextValueEditor",
    i18n = {
