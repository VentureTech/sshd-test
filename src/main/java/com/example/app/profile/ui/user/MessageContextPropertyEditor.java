...
import net.venturetech.sshd_test.communication.service.NotificationService;
...
import static net.venturetech.sshd_test.profile.ui.user.MessageContextPropertyEditorLOK.BUTTON_TEXT_SEND;
import static net.venturetech.sshd_test.profile.ui.user.MessageContextPropertyEditorLOK.ERROR_PONESMS;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.profile.ui.user.MessageContextPropertyEditor",
    i18n = {
