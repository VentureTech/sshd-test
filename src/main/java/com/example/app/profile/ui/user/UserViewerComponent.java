...
import net.venturetech.sshd_test.profile.ui.UIText;
...
import static net.venturetech.sshd_test.profile.ui.user.UserViewerComponentLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.profile.ui.user.UserViewerComponent",
    i18n = {
