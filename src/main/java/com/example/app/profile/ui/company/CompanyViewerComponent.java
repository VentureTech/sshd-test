...
import net.venturetech.sshd_test.profile.model.membership.MembershipTypeInfo;
import net.venturetech.sshd_test.profile.model.terminology.ProfileTerms;
...
import net.venturetech.sshd_test.profile.ui.URLConfigurations;
import net.venturetech.sshd_test.profile.ui.membership.ProfileTypeMembershipTypeManagement;
import net.venturetech.sshd_test.profile.ui.terminology.ProfileTermsEditor;
import net.venturetech.sshd_test.profile.ui.terminology.ProfileTermsViewer;
import net.venturetech.sshd_test.support.ui.Application;
import net.venturetech.sshd_test.support.ui.UIPreferences;
import net.venturetech.sshd_test.support.ui.text.LabelDomainLabelManagement;
...
import static net.venturetech.sshd_test.profile.ui.UIText.*;
import static net.venturetech.sshd_test.profile.ui.URLProperties.COMPANY;
import static net.venturetech.sshd_test.profile.ui.URLProperties.COMPANY_PATH_INFO;
import static net.venturetech.sshd_test.profile.ui.company.CompanyViewerComponentLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.profile.ui.company.CompanyViewerComponent",
    i18n = {
