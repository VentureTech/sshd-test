...
import static net.venturetech.sshd_test.profile.model.company.CompanyModelExtensionLOK.*;
...
@Lazy
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.profile.model.company.CompanyModelExtension",
    i18n = {
