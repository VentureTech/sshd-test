...
import static net.venturetech.sshd_test.profile.model.repository.RepositoryItemStatusLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.profile.model.repository.RepositoryItemStatus",
    i18n = {
