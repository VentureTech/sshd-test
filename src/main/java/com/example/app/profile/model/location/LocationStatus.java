...
import static net.venturetech.sshd_test.profile.model.location.LocationStatusLOK.*;
...
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.profile.model.location.LocationStatus",
    i18n = {
