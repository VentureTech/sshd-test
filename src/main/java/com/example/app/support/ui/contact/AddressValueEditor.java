...
import static net.venturetech.sshd_test.support.ui.contact.AddressValueEditorLOK.*;
...
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.support.ui.contact.AddressValueEditor",
    i18n = {
