...
import static net.venturetech.sshd_test.support.ui.contact.EmailAddressValueEditorLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.support.ui.contact.EmailAddressValueEditor",
    i18n = {
