...
@ComponentScan({"net.venturetech.sshd_test"}/*Scan for spring components in my package hierarchy*/)
...
@PropertySource(
    name = "your-app-props",
    value = {
        "classpath:/net/venturetech/sshd_test/config/default.properties",
...
public class ProjectConfig implements ApplicationListener<ContextRefreshedEvent>
{
    ...
    {
        return "net.venturetech.sshd_test.note";
    }
    ...
    {
        return "net.venturetech.sshd_test.profile";
    }
    ...
    {
        return "classpath*:net/venturetech/sshd_test/mode/schedule/**/*.hbm.xml";
    }
    ...
    public StaticKeyDataConfig staticKeyDataConfig()
    {
        ...
        config.addScanPackage("net.venturetech.sshd_test");
