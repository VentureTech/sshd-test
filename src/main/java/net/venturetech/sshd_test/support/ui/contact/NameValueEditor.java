...
import static net.venturetech.sshd_test.support.ui.contact.NameValueEditorLOK.*;
...
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.support.ui.contact.NameValueEditor",
    i18n = {
