...
import static net.venturetech.sshd_test.support.ui.contact.PhoneNumberValueEditorLOK.*;
...
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.support.ui.contact.PhoneNumberValueEditor",
    i18n = {
