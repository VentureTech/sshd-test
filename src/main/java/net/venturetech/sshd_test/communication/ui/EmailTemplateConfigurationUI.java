...
package net.venturetech.sshd_test.communication.ui;
...
import static net.venturetech.sshd_test.communication.ui.EmailTemplateConfigurationUILOK.*;
import static net.venturetech.sshd_test.profile.ui.UIText.PROFILE;
...
@I18NFile(
    ...
    symbolPrefix = "net.venturetech.sshd_test.communication.ui.EmailTemplateConfigurationUI",
    i18n = {
