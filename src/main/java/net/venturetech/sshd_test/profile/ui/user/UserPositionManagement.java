...
import static net.venturetech.sshd_test.profile.ui.user.UserPositionManagementLOK.*;
import static net.venturetech.sshd_test.support.service.AppUtil.UTC;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.profile.ui.user.UserPositionManagement",
    i18n = {
