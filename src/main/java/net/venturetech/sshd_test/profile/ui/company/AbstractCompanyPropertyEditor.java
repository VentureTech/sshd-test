...
import static net.venturetech.sshd_test.profile.ui.company.AbstractCompanyPropertyEditorLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.profile.ui.company.AbstractCompanyPropertyEditor",
    i18n = {
