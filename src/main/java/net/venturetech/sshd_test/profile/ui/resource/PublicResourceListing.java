...
import static net.venturetech.sshd_test.profile.ui.resource.PublicResourceListingLOK.COMPONENT_NAME;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.profile.ui.resource.PublicResourceListing",
    i18n = {
