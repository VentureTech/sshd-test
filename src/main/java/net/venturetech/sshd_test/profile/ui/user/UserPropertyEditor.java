...
import static net.venturetech.sshd_test.profile.ui.user.UserPropertyEditorLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.profile.ui.user.UserPropertyEditor",
    i18n = {
