...
import net.venturetech.sshd_test.profile.model.user.ContactMethod;
import net.venturetech.sshd_test.profile.model.user.User;
import net.venturetech.sshd_test.profile.model.user.UserDAO;
import net.venturetech.sshd_test.profile.model.user.UserPosition;
...
import net.venturetech.sshd_test.support.service.ContactUtil;
...
import static net.venturetech.sshd_test.profile.ui.UIText.USER;
import static net.venturetech.sshd_test.profile.ui.user.UserManagementLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.profile.ui.user.UserManagement",
    i18n = {
