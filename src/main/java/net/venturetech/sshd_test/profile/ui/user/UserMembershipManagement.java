...
import static net.venturetech.sshd_test.profile.ui.user.UserMembershipManagementLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.profile.ui.user.UserMembershipManagement",
    i18n = {
