...
import static net.venturetech.sshd_test.profile.ui.company.CompanyPropertyEditorLOK.COMPONENT_NAME;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.profile.ui.company.CompanyPropertyEditor",
    i18n = {
