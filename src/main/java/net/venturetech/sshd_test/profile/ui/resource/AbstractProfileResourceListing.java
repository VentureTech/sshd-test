...
package net.venturetech.sshd_test.profile.ui.resource;

import net.venturetech.sshd_test.profile.model.repository.Repository;
import net.venturetech.sshd_test.profile.model.repository.RepositoryItem;
...
import net.venturetech.sshd_test.profile.model.resource.ResourceVisibility;
...
import net.venturetech.sshd_test.profile.ui.repository.ResourceRepositoryItemValueViewer;
import net.venturetech.sshd_test.support.service.AppUtil;
import net.venturetech.sshd_test.support.service.EntityIdCollector;
import net.venturetech.sshd_test.support.service.InstantDayComparator;
import net.venturetech.sshd_test.support.ui.search.KeywordConstraint;
...
import static net.venturetech.sshd_test.profile.ui.resource.AbstractProfileResourceListingLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.profile.ui.resource.AbstractProfileResourceListing",
    i18n = {
