...
import static net.venturetech.sshd_test.profile.ui.repository.ResourceRepositoryItemSelectorLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.profile.ui.repository.ResourceRepositoryItemSelector",
    i18n = {
