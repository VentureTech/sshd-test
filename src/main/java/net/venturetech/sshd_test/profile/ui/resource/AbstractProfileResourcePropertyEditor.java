...
import net.venturetech.sshd_test.profile.model.resource.ResourceDAO;
import net.venturetech.sshd_test.profile.model.resource.ResourceType;
...
import net.venturetech.sshd_test.profile.ui.repository.ResourceRepositoryItemValueEditor;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.profile.ui.resource.AbstractProfileResourcePropertyEditor",
    i18n = {
