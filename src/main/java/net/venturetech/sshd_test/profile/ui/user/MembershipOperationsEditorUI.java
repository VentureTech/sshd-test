...
import static net.venturetech.sshd_test.profile.ui.membership.MembershipTypeOperationsEditorUILOK.*;
import static net.venturetech.sshd_test.profile.ui.user.MembershipOperationsEditorUILOK.MEMBERSHIP_UI_HEADING_FORMAT;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.profile.ui.user.MembershipOperationsEditorUI",
    i18n = {
