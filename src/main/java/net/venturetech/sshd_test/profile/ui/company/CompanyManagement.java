...
import static net.venturetech.sshd_test.profile.model.company.CompanyStatus.Active;
import static net.venturetech.sshd_test.profile.model.company.CompanyStatus.Inactive;
import static net.venturetech.sshd_test.profile.ui.UIText.*;
import static net.venturetech.sshd_test.profile.ui.company.CompanyManagementLOK.*;
import static net.venturetech.sshd_test.profile.ui.company.CompanyValueEditorLOK.LABEL_WEBSITE;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.profile.ui.company.CompanyManagement",
    i18n = {
