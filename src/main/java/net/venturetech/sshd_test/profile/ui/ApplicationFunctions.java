...
public final class ApplicationFunctions
{
    ...
    /**
     * Static class defining Application Functions for {@link net.venturetech.sshd_test.profile.model.company.Company}
     *
     * @author Alan Holt (aholt@venturetech.net)
     */
    public static final class Company
    {
        ...
        /**
         * Static class defining Application Functions for {@link net.venturetech.sshd_test.profile.model.resource.Resource}s on a
         * Company
         *
         * @author Alan Holt (aholt@venturetech.net)
         */
