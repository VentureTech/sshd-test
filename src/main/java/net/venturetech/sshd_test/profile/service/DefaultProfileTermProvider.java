...
package net.venturetech.sshd_test.profile.service;
...
import static net.venturetech.sshd_test.profile.service.DefaultProfileTermProviderLOK.*;
...
@Qualifier("default")
@I18NFile(
    symbolPrefix = "net.venturetech.sshd_test.profile.service.DefaultProfileTermProvider",
    i18n = {
