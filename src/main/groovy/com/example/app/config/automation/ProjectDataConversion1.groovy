...
package net.venturetech.sshd_test.config.automation
 ...
 */
@Profile(["automation", "net.venturetech.sshd_test.demo.1"])
@Configuration
@Lazy
...
class ProjectDataConversion1
{
    ...
    private static final String IDENTIFIER = 'sshd-test'
