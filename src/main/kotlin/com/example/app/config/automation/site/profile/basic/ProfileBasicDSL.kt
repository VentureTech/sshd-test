...
package net.venturetech.sshd_test.config.automation.site.profile.basic

import net.venturetech.sshd_test.config.ProjectInformation
...
open class ProfileBasicDSL : AppDefinition("Profile Basic", version = 1, siteId = "$appName Frontend", init = {
    libraryResources(URL("https://repo.venturetech.net/artifactory/vt-snapshot-local/" +
        "net.venturetech/sshd-test/\${LATEST}/sshd-test-\${LATEST}-libraries.zip"))
    webResources(URL("https://repo.venturetech.net/artifactory/simple/vt-snapshot-local/" +
        "net.venturetech/sshd-test-webdev/\${LATEST}/sshd-test-webdev-\${LATEST}.zip"))
